...
{
    // On scalable-SIMD builds N spans single-strip, grouped multi-strip and
    // strip-group remainders plus scalar column tails for any VLEN <= 512;
    // M covers the specialized small-M kernels (1..4) and the generic path (5).
